...
public class StudentGradeCalculator {
    public static void main(String[] args) {
        ...
        // Display results
        System.out.println("\n--- Student Report ---");
        System.out.printf(" %-20s: %d%n", "Number of Subjects", numSubjects);
        System.out.printf(" %-20s: %d / %d%n", "Total Marks Obtained", totalMarks, maxTotalMarks);
        System.out.printf(" %-20s: %.2f%n", "Average Marks", averageMarks);
